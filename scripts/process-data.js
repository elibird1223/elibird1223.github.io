...
// Read CSV file (V16 dataset from Box)
const csvPath = '/Users/elibird/Library/CloudStorage/Box-Box/BYU_LinkedIn_Profiles/outputs/V16_full_linkedin_gradyear_fix_with_sizes.csv';
...
for (let i = 1; i < lines.length; i++) {
  ...
  // V16 header:
  // First Name,Last Name,LinkedIn URL,Undergrad Year,Grad School Year,
  // First Job Title,First Company,First Company Location,First Date Range,First Industry,
  // Current Job Title,Current Company,Current Company Location,Current Date Range,Current Industry,
  // Graduate School,Degree Type(s),Field of Study,File Name,First Company Size,Current Company Size
  const graduate = {
    firstName: values[0] || '',
    lastName: values[1] || '',
    linkedinUrl: values[2] || '',
    undergradYear: values[3] || '',
    gradSchoolYear: values[4] || '',
    firstJobTitle: values[5] || '',
    firstCompany: values[6] || '',
    firstLocation: values[7] || '',
    firstDateRange: values[8] || '',
    firstIndustry: values[9] || '',
    currentJobTitle: values[10] || '',
    currentCompany: values[11] || '',
    currentLocation: values[12] || '',
    currentDateRange: values[13] || '',
    currentIndustry: values[14] || '',
    gradSchool: values[15] || '',
    degreeType: values[16] || '',
    fieldOfStudy: values[17] || '',
    sourceFileName: values[18] || '',
    firstCompanySize: values[19] || '',
    currentCompanySize: values[20] || ''
  };
