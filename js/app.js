...
const App = {
  ...
  switchView(view) {
    ...
    if (view === 'stats' && !this.industryChart) {
      this.initCharts();
    }
  },
  ...
  setupStats() {
    ...
    document.getElementById('total-gradschools').textContent = stats.topGradSchools.length;
    ...
    degreeTypes.innerHTML = stats.degreeTypes.map(([type, count]) => `
